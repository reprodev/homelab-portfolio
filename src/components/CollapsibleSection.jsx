    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className={`p-2.5 rounded-2xl bg-white/5 border border-white/10 transition-transform duration-500 ${isExpanded ? 'rotate-180 bg-white/10 border-white/20 shadow-[0_0_15px_rgba(0,102,204,0.3)]' : ''}`}>
