...
function App() {
  ...
  if (showSplash === null) return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center">
      <div className="text-white/10 text-[10px] font-mono uppercase tracking-[0.6em] animate-pulse">
      ...
      <AnimatePresence mode="wait">
        {showSplash ? (
          ...
          >
            ...
            {/* Portal Reopen Button (Floating) */}
            <motion.button
              initial={{ scale: 0, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              transition={{ delay: 2 }}
              onClick={() => setShowSplash(true)}
              className="fixed top-6 right-6 z-[60] p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl group hover:bg-white/10 transition-all hover:scale-105 active:scale-95 shadow-2xl"
